      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-12 lg:py-16">
        <div className="grid lg:grid-cols-[1.15fr_0.85fr_0.85fr] gap-12">
          <div className="space-y-5">
            ...
            <Link to="/appointments" className="inline-flex items-center gap-2 text-sm font-bold text-whetstone-cream hover:text-honed-sage transition-colors">Book Your Arrival <FiArrowRight /></Link>
          </div>
