...
const { FiCalendar, FiClock, FiUser, FiCheck, FiArrowLeft, FiSun, FiMoon, FiSunrise, FiAlertCircle } = FiIcons;
...
const ReservationForm = () => {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const resId = reservation.id.substring(0, 8).toUpperCase();
      ...
      await supabase.from('communications').insert({
        ...
        content: `Booking confirmed for ${formData.selectedSlot}. Payment due at pickup.`
      });
        ...
        {currentStep === 3 && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <h2 className="font-serif font-bold text-2xl">Confirm Details</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Right: Order Summary */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-damascus-bronze border-b border-white/10 pb-2">Order Summary</h3>
                ...
                <div className="bg-carbon-black/30 p-4 rounded-lg space-y-2 mt-4">
                  <div className="flex justify-between text-sm">
                    <span>Estimated Total</span>
                    <span>${subtotal.toFixed(2)}</span>
                  </div>
                  <p className="text-xs text-gray-400 mt-2 italic">
                    * Final payment collected safely at pickup.
                  </p>
                </div>
                ...
                <div className="mt-6">
                  {!formData.name || !formData.email || !formData.phone ? (
                    <div className="text-center text-sm text-gray-400 bg-white/5 p-3 rounded">
                      Please complete contact details to book
                    </div>
                  ) : (
                    <button
                    ...
                    >
                      {isProcessing ? 'Booking...' : 'Confirm Reservation'}
                    </button>
                  )}
                </div>
              </div>
        ...
        {currentStep === 4 && (
          ...
          >
            ...
            <p className="text-gray-300 mb-8 max-w-md mx-auto">
              ...
              <br/><br/>
              <span className="text-honed-sage font-bold">Payment is due upon pickup.</span>
            </p>
