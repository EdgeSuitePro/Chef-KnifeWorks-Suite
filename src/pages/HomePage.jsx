      ...
      <section className="relative border-b border-white/10 bg-[#0a0b0a]">
        ...
        <div className="relative max-w-[1500px] mx-auto px-5 sm:px-8 lg:px-10 py-16 md:py-20 lg:py-24 grid lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-14 items-center min-h-[620px]">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-7"><Link to="/appointments" className="inline-flex items-center justify-center gap-3 rounded-xl bg-honed-sage px-7 py-4 font-bold text-white hover:bg-damascus-bronze transition-colors shadow-lg shadow-black/20">Book Your Arrival <FiArrowRight /></Link><a href="#how-it-works" className="inline-flex items-center justify-center rounded-xl border border-white/20 px-7 py-4 font-semibold text-white/85 hover:bg-white/5 transition-colors">See How It Works</a></div>
